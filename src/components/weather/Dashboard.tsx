  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row h-[calc(100vh-56px)]">
        {/* Mappa */}
        <div
          className={`w-full lg:w-1/2 h-[30vh] lg:h-full ${showOnboarding ? "invisible" : ""}`}
        >
          <Suspense
            fallback={
              ...
              <>
                ...
                {activeTab === "oggi" && (
                  <div className="space-y-4">
                    <FeatureHint
                      id="nowcasting-hint"
                      title="Nowcasting in tempo reale"
                      description="Precipitazioni previste nei prossimi 120 minuti con aggiornamenti ogni 5 minuti. Utile per decidere se entrare in campo."
                      isDismissed={isTooltipDismissed("nowcasting-hint")}
                ...
                {activeTab === "colture" && (
                  <div className="space-y-4">
                    <FeatureHint
                      id="gdd-hint"
                      title="Dati stagionali reali"
                      description="Gradi Giorno e Ore di Freddo calcolati con dati storici reali dall'inizio della stagione, non stime."
                      isDismissed={isTooltipDismissed("gdd-hint")}
                      onDismiss={dismissTooltip}
                    />
                    {weatherLoading || !weather ? (
                      <>
                ...
                {activeTab === "rischi" && (
                  <div className="space-y-4">
                    <FeatureHint
                      id="disease-hint"
                      title="Modelli agronomici"
                      description="Il rischio malattie è calcolato in base a temperatura, umidità e ore di bagnatura fogliare secondo modelli fitopatologici."
                      isDismissed={isTooltipDismissed("disease-hint")}
                      onDismiss={dismissTooltip}
                    />
                    {weatherLoading || !weather ? (
                      <>
