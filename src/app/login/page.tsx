    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-900 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">AgriWeather Dashboard</CardTitle>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
            Accedi per salvare le tue preferenze e colture
          </p>
        </CardHeader>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border rounded-lg bg-white dark:bg-slate-800 dark:border-slate-600"
                  required
                />
              </div>
            </div>
